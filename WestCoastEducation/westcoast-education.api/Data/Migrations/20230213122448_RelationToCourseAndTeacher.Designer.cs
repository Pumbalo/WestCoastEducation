...
namespace westcoasteducation.api.Data.Migrations
{
    ...
    [Migration("20230213122448_RelationToCourseAndTeacher")]
    partial class RelationToCourseAndTeacher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("westcoast_education.api.Models.TeacherModel", b =>
                {
                    ...
                    b.Property<int?>("CompetenceModelId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("westcoast_education.api.Models.TeacherModel", b =>
                {
                    b.HasOne("westcoast_education.api.Models.CompetenceModel", null)
                        .WithMany("Teacher")
                        .HasForeignKey("CompetenceModelId");
                });
